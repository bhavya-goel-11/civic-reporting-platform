...
export default function Home() {
    ...
    <div className="font-sans min-h-screen w-full">
      ...
      <section className="relative overflow-hidden" aria-label="Hero" role="banner">
        <div aria-hidden className="absolute inset-0 pointer-events-none select-none">
          <div className="absolute -top-32 -left-32 h-72 w-72 rounded-full bg-gradient-to-br from-zinc-300/20 to-zinc-500/10 blur-3xl" />
          <div className="absolute bottom-0 right-0 h-80 w-80 rounded-full bg-gradient-to-tr from-zinc-200/20 to-zinc-400/10 blur-3xl" />
        </div>
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-28 flex flex-col items-center text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight bg-gradient-to-r from-zinc-900 via-zinc-700 to-zinc-600 bg-clip-text text-transparent dark:from-zinc-200 dark:via-zinc-300 dark:to-zinc-400">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Link
              href="/report"
              className="inline-flex justify-center items-center rounded-lg bg-zinc-900 px-8 py-4 text-base font-semibold text-white shadow-sm hover:bg-zinc-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-600 transition"
            >
              Report Now
            </Link>
            <Link
              href="/track"
              className="inline-flex justify-center items-center rounded-lg border border-zinc-300 px-8 py-4 text-base font-semibold text-zinc-800 hover:bg-zinc-100 dark:text-zinc-200 dark:border-zinc-700 dark:hover:bg-zinc-800 transition"
            >
              Track Report
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-10">
            <div className="flex flex-col items-center text-center gap-4">
              <div className="h-16 w-16 rounded-xl bg-gradient-to-br from-zinc-800 to-zinc-600 flex items-center justify-center shadow-md text-white">
                {/* Camera icon */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="flex-1 w-full">
              ...
              <Link href="/map" className="inline-flex items-center gap-2 rounded-lg bg-zinc-900 hover:bg-zinc-800 text-white px-6 py-3 font-medium shadow-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-600 transition">
                See All Reports
            ...
            <div className="flex-1 w-full">
              <div className="relative aspect-[4/3] w-full rounded-xl border border-zinc-200 dark:border-zinc-800 bg-gradient-to-br from-zinc-100 via-zinc-50 to-zinc-200 dark:from-zinc-900/30 dark:via-zinc-900/20 dark:to-zinc-800/20 overflow-hidden" aria-label="Static example map">
  ...
  <section className="relative py-24 bg-white dark:bg-zinc-950" aria-labelledby="why-use-heading">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="rounded-2xl border border-zinc-200/70 dark:border-zinc-800 p-8 bg-gradient-to-br from-zinc-50 to-white dark:from-zinc-900 dark:to-zinc-950 shadow-sm">
              <h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100 mb-4">For Citizens</h3>
              <ul className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
                <li className="flex gap-3"><span className="mt-0.5 text-zinc-400" aria-hidden>•</span> <span>Easy, intuitive report flow with photo & location.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-zinc-400" aria-hidden>•</span> <span>Transparent status updates & notifications.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-zinc-400" aria-hidden>•</span> <span>Build community impact with visible progress.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-zinc-400" aria-hidden>•</span> <span>Mobile-friendly & fast – report in seconds.</span></li>
              </ul>
            </div>
            <div className="rounded-2xl border border-zinc-200/70 dark:border-zinc-800 p-8 bg-gradient-to-br from-zinc-50 to-white dark:from-zinc-900 dark:to-zinc-950 shadow-sm">
              <h3 className="text-xl font-semibold text-zinc-800 dark:text-zinc-100 mb-4">For City Staff</h3>
              <ul className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
                <li className="flex gap-3"><span className="mt-0.5 text-zinc-400" aria-hidden>•</span> <span>Centralized dashboard & workload visibility.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-zinc-400" aria-hidden>•</span> <span>Auto-routing by category & location.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-zinc-400" aria-hidden>•</span> <span>Performance analytics & SLA tracking.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-zinc-400" aria-hidden>•</span> <span>Faster resolution & citizen satisfaction.</span></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <section className="relative py-28 bg-gradient-to-br from-zinc-100 via-zinc-200 to-zinc-300 dark:from-zinc-900 dark:via-zinc-900/80 dark:to-zinc-800" aria-labelledby="final-cta-heading">
          ...
          <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center text-zinc-900 dark:text-zinc-100">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center gap-5">
              <Link href="/report" className="inline-flex items-center justify-center rounded-xl bg-zinc-900 text-white font-semibold px-10 py-4 text-base shadow-sm hover:bg-zinc-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-600 transition">
                Start Reporting Now
              </Link>
              <div className="flex items-center gap-3" aria-label="App store badges (coming soon)">
                <div className="h-12 w-36 rounded-lg border border-zinc-300 dark:border-zinc-700 flex items-center justify-center text-xs font-medium tracking-wide uppercase text-zinc-700 dark:text-zinc-200 bg-white/60 dark:bg-white/5 backdrop-blur-sm">
                  App Store
                </div>
                <div className="h-12 w-36 rounded-lg border border-zinc-300 dark:border-zinc-700 flex items-center justify-center text-xs font-medium tracking-wide uppercase text-zinc-700 dark:text-zinc-200 bg-white/60 dark:bg-white/5 backdrop-blur-sm">
                  Play Store
