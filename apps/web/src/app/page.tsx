...
export default function Home() {
  return (
    <div className="font-sans min-h-screen w-full">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-stone-50 via-amber-50 to-white dark:from-stone-950 dark:via-stone-900 dark:to-stone-950" aria-label="Hero" role="banner">
        <div aria-hidden className="absolute inset-0 pointer-events-none select-none">
          <div className="absolute -top-32 -left-32 h-72 w-72 rounded-full bg-gradient-to-br from-amber-300/25 to-orange-400/15 blur-3xl" />
          <div className="absolute bottom-0 right-0 h-80 w-80 rounded-full bg-gradient-to-tr from-amber-200/20 to-stone-400/10 blur-3xl" />
        </div>
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-28 flex flex-col items-center text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight bg-gradient-to-r from-amber-900 via-orange-800 to-stone-700 bg-clip-text text-transparent dark:from-amber-200 dark:via-orange-200 dark:to-stone-200">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Link
              href="/report"
              className="inline-flex justify-center items-center rounded-lg bg-amber-800 px-8 py-4 text-base font-semibold text-white shadow-sm hover:bg-amber-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-700 transition"
            >
              Report Now
            </Link>
            <Link
              href="/track"
              className="inline-flex justify-center items-center rounded-lg border border-amber-300 px-8 py-4 text-base font-semibold text-amber-900 hover:bg-amber-50 dark:text-amber-200 dark:border-amber-700 dark:hover:bg-amber-900/20 transition"
            >
              Track Report
            </Link>
          </div>
          <div className="mt-14 w-full max-w-5xl aspect-[16/7] rounded-2xl border border-stone-200/70 dark:border-stone-800 bg-gradient-to-br from-stone-50 to-amber-50 dark:from-stone-900 dark:to-stone-950 flex items-center justify-center text-stone-400 text-sm sm:text-base">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-10">
            <div className="flex flex-col items-center text-center gap-4">
              <div className="h-16 w-16 rounded-xl bg-gradient-to-br from-amber-700 to-orange-600 flex items-center justify-center shadow-md text-white">
                {/* Camera icon */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="flex-1 w-full">
              ...
              <Link href="/map" className="inline-flex items-center gap-2 rounded-lg bg-amber-800 hover:bg-amber-700 text-white px-6 py-3 font-medium shadow-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-700 transition">
                See All Reports
            ...
            <div className="flex-1 w-full">
              <div className="relative aspect-[4/3] w-full rounded-xl border border-amber-200 dark:border-stone-800 bg-gradient-to-br from-amber-50 via-stone-50 to-amber-100 dark:from-stone-900/30 dark:via-stone-900/20 dark:to-stone-800/20 overflow-hidden" aria-label="Static example map">
                ...
                <div className="absolute inset-0" aria-hidden>
                  <span className="absolute left-[18%] top-[28%] -translate-x-1/2 -translate-y-1/2 flex h-8 w-8 items-center justify-center rounded-full bg-amber-600 text-white text-xs font-semibold shadow-lg shadow-amber-600/30">P</span>
                  <span className="absolute left-[62%] top-[52%] -translate-x-1/2 -translate-y-1/2 flex h-8 w-8 items-center justify-center rounded-full bg-lime-700 text-white text-xs font-semibold shadow-lg shadow-lime-700/30">T</span>
                  <span className="absolute left-[40%] top-[70%] -translate-x-1/2 -translate-y-1/2 flex h-8 w-8 items-center justify-center rounded-full bg-rose-700 text-white text-xs font-semibold shadow-lg shadow-rose-700/30">L</span>
                  <span className="absolute left-[78%] top-[24%] -translate-x-1/2 -translate-y-1/2 flex h-8 w-8 items-center justify-center rounded-full bg-stone-700 text-white text-xs font-semibold shadow-lg shadow-stone-700/30">R</span>
                </div>
                <div className="absolute bottom-0 left-0 right-0 bg-white/70 dark:bg-stone-900/70 backdrop-blur px-4 py-2 text-[11px] flex items-center justify-between gap-4 text-stone-600 dark:text-stone-400">
  ...
  <section className="relative py-24 bg-white dark:bg-zinc-950" aria-labelledby="why-use-heading">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="rounded-2xl border border-amber-200/70 dark:border-stone-800 p-8 bg-gradient-to-br from-amber-50 to-stone-50 dark:from-stone-900 dark:to-stone-950 shadow-sm">
              <h3 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mb-4">For Citizens</h3>
              <ul className="space-y-3 text-sm text-stone-700 dark:text-stone-300">
                <li className="flex gap-3"><span className="mt-0.5 text-amber-500" aria-hidden>•</span> <span>Easy, intuitive report flow with photo & location.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-amber-500" aria-hidden>•</span> <span>Transparent status updates & notifications.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-amber-500" aria-hidden>•</span> <span>Build community impact with visible progress.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-amber-500" aria-hidden>•</span> <span>Mobile-friendly & fast – report in seconds.</span></li>
              </ul>
            </div>
            <div className="rounded-2xl border border-amber-200/70 dark:border-stone-800 p-8 bg-gradient-to-br from-amber-50 to-stone-50 dark:from-stone-900 dark:to-stone-950 shadow-sm">
              <h3 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mb-4">For City Staff</h3>
              <ul className="space-y-3 text-sm text-stone-700 dark:text-stone-300">
                <li className="flex gap-3"><span className="mt-0.5 text-amber-500" aria-hidden>•</span> <span>Centralized dashboard & workload visibility.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-amber-500" aria-hidden>•</span> <span>Auto-routing by category & location.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-amber-500" aria-hidden>•</span> <span>Performance analytics & SLA tracking.</span></li>
                <li className="flex gap-3"><span className="mt-0.5 text-amber-500" aria-hidden>•</span> <span>Faster resolution & citizen satisfaction.</span></li>
              </ul>
            </div>
          </div>
        </div>
