...
export default function MapView() {
  ...
  // Unique key to force remount if needed
  const [mapKey] = useState(() => `${Date.now()}-${Math.random()}`);
  ...
  return (
    <div style={{ height: '100%', width: '100%' }}>
      <MapContainer key={mapKey} center={[28.6139, 77.2090]} zoom={11} style={{ height: '100%', width: '100%' }}>
